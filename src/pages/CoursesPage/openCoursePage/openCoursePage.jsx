...
import like from '../../../assets/CoursesPage/favorite.svg'
import {viewsConverter} from "../../../functions/viewsConverter.jsx";
import {toDate} from "../../../functions/toDate.jsx";


const OpenCoursePage = ({code, title, date , likes, isLiked, desc, avatar, views}) => {
            ...
            <div className="container">
                <div className={c.open_course__inner}>
                    ...
                    <div className={c.open_course__under}>
                        ...
                        <div className={c.right_side_video}></div>
                    </div>
                </div>
            </div>
        </div>
